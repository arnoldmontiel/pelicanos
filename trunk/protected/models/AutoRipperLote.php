...
/**
 * This is the model class for table "auto_ripper_lote".
 *
 * The followings are the available columns in table 'auto_ripper_lote':
 * @property integer $Id
 ...
 */
class AutoRipperLote extends CActiveRecord
{
	/**
	 ...
	 * @return AutoRipperLote the static model class
	 */
