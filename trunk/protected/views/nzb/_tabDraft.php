<div class="searchOverTab"><button onclick="searchTabDraft('');" class="resetSearchBtn" type="button" ><i class="fa fa-times-circle"></i></button><input onchange="searchTabDraft(this.value);" type="text" value="<?php echo $filter;?>" class="form-control" placeholder=" Buscar Pel&iacute;cula"></div>
	<?php 
