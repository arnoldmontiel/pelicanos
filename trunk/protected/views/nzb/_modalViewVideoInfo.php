			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-9">
					<ul class="nav nav-tabs">
						<li class="<?php echo ($activeTab==1)?'active':'';?>"><a
							href="#tab21" data-toggle="tab">Informaci&oacute;n</a></li>
						<li class="<?php echo ($activeTab==2)?'active':'';?>"><a
							href="#tab23" data-toggle="tab">Archivos</a></li>
						<li class="pull-right"><button id="btn-edit"
								onclick="editVideoInfo(<?php echo $modalAutoRipper->Id_nzb;?>);"
								type="button" class="btn btn-default">
								<i class="fa fa-pencil"></i> Editar Informaci&oacute;n
							</button></li>
					</ul>
					<div class="tab-content tableInfo">
						<div class="tab-pane <?php echo ($activeTab==1)?'active':'';?>"
							id="tab21">
							<div class="row detailSecondGroup">
								<div
									class="col-md-3 col-sm-3 align-left detailSecond detailSecondFirst">
									GENERO</div>
								<!--/.col-md-3 -->
							...
							<div class="row detailSecondGroup">
								...
								<!--/.col-md-3 -->
								<div
									class="col-md-9 col-sm-9 align-left detailSecond detailSummary">
						...
						<div class="tab-pane <?php echo ($activeTab==2)?'active':'';?>"
							id="tab23">
							<!--/.bookmarks -->
							<table class="table tablaArchivos">
								...
								foreach ( $modelNzbs as $nzb ) {
									...
									if ($nzb->Id_creation_state == 4)
										...
										echo CHtml::dropDownList ( "nzbType", $nzb->Id_nzb_type, $list, array (
												'class' => 'form-control',
												'id' => 'ddl-nzb-' . $nzb->Id,
