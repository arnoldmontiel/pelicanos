...
INSERT INTO `itemchildren` VALUES ('Administrator','AnydvdhdVersionManage'),('Administrator','AutoRipperManage'),('Administrator','ClientSettingsManage'),('Administrator','CustomerManage'),('Administrator','DeviceManage'),('Administrator','NzbManage'),('Administrator','ResellerManage'),('Administrator','SerieManage'),('Administrator','SiteManage'),('Administrator','UserManage'),('Administrator','WsAutoRipperManage'),('AnydvdhdVersionManage','AnydvdhdVersionAdmin'),('AnydvdhdVersionManage','AnydvdhdVersionIndex'),('AutoRipperManage','AutoRipperAdmin'),('AutoRipperManage','AutoRipperAdminState'),('AutoRipperManage','AutoRipperUpdate'),('AutoRipperManage','AutoRipperView'),('ClientSettingsManage','ClientSettingsIndex'),('ClientSettingsManage','ClientSettingsView'),('CustomerManage','CustomerSummary'),('CustomerManage','CustomerSummaryNzb'),('CustomerManage','CustomerSummaryRipped'),('CustomerManage','CustomerView'),('CustomerManage','CustomerViewSummaryRipped'),('CustomerManageOp','CustomerAdmin'),('CustomerManageOp','CustomerCreate'),('CustomerManageOp','CustomerCustomerMovies'),('CustomerManageOp','CustomerCustomerTransaction'),('CustomerManageOp','CustomerIndex'),('CustomerManageOp','CustomerIndexRipped'),('CustomerManageOp','CustomerUpdate'),('CustomerManageOp','CustomerUsersUpdate'),('CustomerManageOp','CustomerView'),('CustomerManageOp','CustomerViewRipped'),('DeviceManage','DeviceAdmin'),('DeviceManage','DeviceIndex'),('DeviceManage','DeviceView'),('MovieManageOp','NzbIndexEpisodeReseller'),('MovieManageOp','NzbIndexReseller'),('MovieManageOp','NzbViewEpisodeReseller'),('MovieManageOp','NzbViewReseller'),('NzbManage','NzbAdmin'),('NzbManage','NzbAdminBox'),('NzbManage','NzbCreate'),('NzbManage','NzbCreateEpisode'),('NzbManage','NzbCreateMovie'),('NzbManage','NzbDelete'),('NzbManage','NzbFindSubtitle'),('NzbManage','NzbIndex'),('NzbManage','NzbIndexEpisode'),('NzbManage','NzbIndexTv'),('NzbManage','NzbUpdate'),('NzbManage','NzbUploadSubtitle'),('NzbManage','NzbView'),('NzbManage','NzbViewEpisode'),('Operator','CustomerManageOp'),('Operator','MovieManageOp'),('Operator','SerieManageOp'),('Operator','SiteManage'),('Operator','UserManageOp'),('ResellerManage','ResellerAdmin'),('ResellerManage','ResellerCreate'),('ResellerManage','ResellerIndex'),('ResellerManage','ResellerUpdate'),('ResellerManage','ResellerView'),('SerieManage','ImdbdataTvIndex'),('SerieManage','ImdbdataTvSetSeason'),('SerieManage','ImdbdataTvView'),('SerieManage','ImdbdataTvViewSeason'),('SerieManageOp','NzbIndexTvReseller'),('SiteManage','SiteIndex'),('UserManage','UserSummary'),('UserManage','UserSummaryUpdate'),('UserManageOp','UserAdmin'),('UserManageOp','UserCreate'),('UserManageOp','UserDelete'),('UserManageOp','UserIndex'),('UserManageOp','UserUpdate'),('UserManageOp','UserView'),('WsAutoRipperManage','WsAutoRipperWsdl');
