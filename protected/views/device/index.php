				...
				{					
					...
					if(obj.modelDevice != null)
					{
						...
						if(objDevice != null)
						{
							...
							$("#Device_sabnzb_pwd_file_path").val(objDevice.sabnzb_pwd_file_path);
							...
							$("#Device_host_name").val(objDevice.host_name);
							...
							$("#Device_michael_jackson").val(objDevice.michael_jackson);
...
<div class="container" id="screenDispositivos">
	...
	<div id="container-modal-addPort" style="display: none">
		<?php echo $this->renderPartial('_modalPortConfig', array( 'modelSabNzbdConfigs'=>$modelSabNzbdConfigs, 'modelDeviceTunelGrid'=>$modelDeviceTunelGrid, 'idDevice'=>''));?>
	</div>
