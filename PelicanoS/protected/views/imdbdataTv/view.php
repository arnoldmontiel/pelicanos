...
if($model->Deleted_serie == 1)
{
	$this->menu=array(
		...
		array('label'=>'Re-create Serie', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->ID),'confirm'=>'Are you sure you want to re-create this item?')),
...
else 
{
	$this->menu=array(
		...
		array('label'=>'Delete Serie', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->ID),'confirm'=>'Are you sure you want to delete this item?')),
		array('label'=>'Manage Series Tv', 'url'=>array('admin')),
